        ...
        for _ in range(n_runs):
            ...
            for _ in range(n_growth):
                ...
                if p < growth_failure_rate:
                    ...
                    growth_investments.append(skewnorm.rvs(a=growth_skewness, loc=growth_distribution_mean, scale=growth_distribution_std))
...
def main():
    ...
    # Sidebar controls
    n_runs = st.sidebar.number_input("Number of simulations:", min_value=10, value=100, step=10)
    ...
    vc_power_law_exponent = st.sidebar.slider("VC Power Law Exponent:", min_value=0.0, max_value=10.0, value=2.0, step=0.1)
    ...
    growth_distribution_mean = st.sidebar.slider("Growth Distribution Mean:", min_value=0.0, max_value=50.0, value=5.0, step=1.0)
