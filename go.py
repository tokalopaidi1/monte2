...
@st.cache_data
def monte_carlo_simulation(n_runs, fund, n_investments, vc_failure_rate, vc_min_return, vc_max_return, vc_pareto_b,
        ...
        for _ in range(n_runs):
            ...
            for _ in range(n_vc):
                ...
                if p < vc_failure_rate:
                    ...
                    multiplier = pareto.rvs(b=vc_pareto_b)  # Pareto distribution
                    vc_investments.append(max(multiplier, vc_min_return))
...
def main():
    ...
    vc_pareto_b = st.sidebar.slider("VC Pareto Shape Parameter (b):", min_value=0.01, max_value=3.0, value=0.5, step=0.01)
    ...
    # Data Generation
    df, summary = monte_carlo_simulation(n_runs, fund, n_investments, vc_failure_rate, vc_min_return, vc_max_return, vc_pareto_b,
                                         growth_failure_rate, growth_min_return, growth_max_return, growth_distribution_mean, growth_distribution_std, growth_distribution_skew)
